...
def main():
    ...
    columns = [
        ...
        "DCGM_FI_PROF_PIPE_TENSOR_IMMA_ACTIVE_min","DCGM_FI_PROF_PIPE_TENSOR_IMMA_ACTIVE_avg","DCGM_FI_PROF_PIPE_TENSOR_IMMA_ACTIVE_max",
        "DCGM_FI_PROF_PIPE_TENSOR_HMMA_ACTIVE_min","DCGM_FI_PROF_PIPE_TENSOR_HMMA_ACTIVE_avg","DCGM_FI_PROF_PIPE_TENSOR_HMMA_ACTIVE_max",
        "DCGM_FI_PROF_PIPE_TENSOR_DFMA_ACTIVE_min","DCGM_FI_PROF_PIPE_TENSOR_DFMA_ACTIVE_avg","DCGM_FI_PROF_PIPE_TENSOR_DFMA_ACTIVE_max",
        ...
        "DCGM_FI_PROF_PIPE_INT_ACTIVE_min","DCGM_FI_PROF_PIPE_INT_ACTIVE_avg","DCGM_FI_PROF_PIPE_INT_ACTIVE_max",
